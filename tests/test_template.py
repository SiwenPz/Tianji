...
class TestHookE2e:
    ...
    def test_codex_session_start_writes_to_ledger(self, conn, controller):
        ctrl = conn.execute(
    ...
    def test_codex_pre_tool_use_derives_working(self, conn, controller):
        env = _env("总控", controller["secret"])
    ...
    def test_codex_stop_derives_waiting(self, conn, controller):
        env = _env("总控", controller["secret"])
        ingest_event(conn, env, {
    ...
    def test_claude_hook_e2e(self, conn, controller):
