...
def test_spawn_flags_display_mode():
    ...
    assert _spawn_flags("claude", "后台") == subprocess.CREATE_NO_WINDOW
    assert _spawn_flags("claude", "前台") == subprocess.CREATE_NEW_CONSOLE
    assert _spawn_flags('kimi -p "任务"', "前台") == subprocess.CREATE_NO_WINDOW
    assert _spawn_flags('kimi -p "任务"', "后台") == subprocess.CREATE_NO_WINDOW
